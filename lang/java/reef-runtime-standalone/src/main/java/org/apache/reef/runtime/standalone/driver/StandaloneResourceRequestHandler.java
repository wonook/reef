...
final class StandaloneResourceRequestHandler implements ResourceRequestHandler {
  private static final Logger LOG = Logger.getLogger(StandaloneResourceRequestHandler.class.getName());
  ...
  public void onNext(final ResourceRequestEvent resourceRequestEvent) {
    LOG.log(Level.FINEST, "Standalone Resource Request");
    nodeListManager.onResourceRequest(resourceRequestEvent);
  }
}
