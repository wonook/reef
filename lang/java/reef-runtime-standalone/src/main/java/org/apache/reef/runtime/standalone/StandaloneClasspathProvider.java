...
/**
 * RuntimeClasspathProvider for the standalone runtime.
 * <p>
 * The prefix for the standalone runtime is empty, the suffix is the classpath of the current JVM. That classpath is
 * filtered to not contain subfolders of JAVA_HOME. Also, duplicates are removed.
 */
public final class StandaloneClasspathProvider implements RuntimeClasspathProvider {
  private final List<String> classPathSuffix;

  @Inject
  StandaloneClasspathProvider() {
