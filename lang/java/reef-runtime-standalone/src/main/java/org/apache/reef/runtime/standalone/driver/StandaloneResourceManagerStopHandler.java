...
final class StandaloneResourceManagerStopHandler implements ResourceManagerStopHandler {
  private static final Logger LOG = Logger.getLogger(StandaloneResourceManagerStopHandler.class.getName());
  ...
  public void onNext(final RuntimeStop runtimeStop) {
    LOG.log(Level.FINEST, "Standalone ResourceManager Stop");
  }
}
