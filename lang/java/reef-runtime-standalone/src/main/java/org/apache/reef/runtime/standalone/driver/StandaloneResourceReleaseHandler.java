...
final class StandaloneResourceReleaseHandler implements ResourceReleaseHandler {
  private static final Logger LOG = Logger.getLogger(StandaloneResourceReleaseHandler.class.getName());
  ...
  public void onNext(final ResourceReleaseEvent resourceReleaseEvent) {
    LOG.log(Level.FINEST, "Standalone Resource Release");
  }
}
