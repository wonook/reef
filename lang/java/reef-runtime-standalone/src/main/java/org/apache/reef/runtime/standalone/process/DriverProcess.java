 ...
 */
public final class DriverProcess implements Runnable {

  private static final Logger LOG = Logger.getLogger(DriverProcess.class.getName());
   ...
   */
  public DriverProcess(final List<String> command,
                       final String id,
                       final File folder,
    ...
    LOG.log(Level.FINEST, "DriverProcess ready.");
  }
